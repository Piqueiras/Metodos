function [x_vals, y_vals] = ERK_yn(fid, f, a, eta, h, N, A, b, c, sol)
    % RUNGE KUTTA EXPLÍCITO GENERAL CON EL MÉTODO DE LOS yni
    ...
    for n = 1:N % Calcular en cada paso el yn
        ...
        % yni = yn + h * sum(aij * f(xnj,ynj))
        yn(:,i) = y_vals(:,n) + h*sumaAK;
        end
